...
class NeRF():
    ...
    def generate_point_cloud(self,
        ...
        if densify_scene:
            ...
            opacities, scales, quats, affordance, clip_embeds \
                = self.pipeline.model.opacities, self.pipeline.model.scales, self.pipeline.model.quats, \
                    self.pipeline.model.affordance, self.pipeline.model.clip_embeds
        ...
        if use_bounding_box:
            ...
            # other attributes of the Gaussian
            opacities, scales, quats, affordance, clip_embeds \
                = opacities[mask], scales[mask], quats[mask], affordance[mask], clip_embeds[mask]
        else:
            mask = None
